...
export const heroData = {
  ...
  headline: "مشاوره تخصصی، راهی به سوی سودآوری پایدار سازمان شما",
  subHeader:
    "با مشاوره تخصصی، وفاداری مشتریان را افزایش داده و  اعتبار سازمانتان را در بازار بهبود دهید",
...
export const gridItems = [
  ...
  {
    title: "بالغ بر ۲۰ سال تجربه",
    description: "در حوزه مدیریت و خدمات پس از فروش",
  },
  {
    title: "روش اجرایی",
